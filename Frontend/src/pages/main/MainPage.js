...
import './MainPage.css';
  ...
  const hotQuestData = [
    {
      id: 1,
      title: '천안 중앙시장 탐방 퀘스트',
      region: '충남 천안',
      description: '중앙시장 먹거리 골목과 상점들을 연결해 즐기는 도심 탐험 미션입니다.'
    },
    {
      id: 2,
      title: '불당동 카페거리 감성 퀘스트',
      region: '천안 불당동',
      description: '카페거리의 분위기와 숨은 스팟을 따라 움직이는 천안 로컬 미션입니다.'
    },
    {
      id: 3,
      ...
      <div className="main-page">
        <section className="hero-map-section">
          <div className="hero-copy">
            ...
            <p className="hero-description">
              단순한 방문이 아닙니다. GPS와 QR 인증을 통해 천안 곳곳에 숨겨진 퀘스트를 수행하고,
          ...
          <div className="map-shell is-consented">
            ...
            {mapStatus === 'missing-key' && (
              <div className="map-overlay-message">
                <code>REACT_APP_KAKAO_MAP_KEY</code> 값이 없어서 지도를 표시할 수 없습니다.
              </div>
            )}
            {mapStatus === 'error' && (
              <div className="map-overlay-message">
                지도를 불러오는 중 문제가 발생했습니다. 카카오 콘솔의 허용 도메인과 앱키를 확인해주세요.
              </div>
            )}
          </div>
        </section>
        ...
        <section className="partner-banner-section">
          <div className="partner-banner partner-banner-cta">
            ...
            <p>
              Local Quest 파트너가 되어 매장에 활기를 더하세요. 실방문객 중심의 마케팅 효과를 직접 경험해보세요.
            </p>
        ...
        {showConsentModal && (
          <div className="modal-overlay" onClick={handleConsentClose}>
            <div className="modal-card" onClick={(e) => e.stopPropagation()}>
              <h3>위치기반서비스 이용 동의</h3>
              <p>
                천안 지역 퀘스트와 연결된 지도 상세 위치를 확인하려면 위치기반서비스 이용 동의가 필요합니다.
              </p>
